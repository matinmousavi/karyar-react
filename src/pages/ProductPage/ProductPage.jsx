      ...
      <div className='container'>
        <div className='ProductPage_top'>
          ...
          <div className='ProductPage_top_info'>
            <p className='ProductPage_top_info_title'>PRODUCT NAME GOES HERE</p>
            ...
            <div className='ProductPage_top_info_price'>
              <span className='ProductPage_top_info_price_main'>$980.00</span>
              <del className='ProductPage_top_info_price_delet'>$990.00</del>
              <span className='ProductPage_top_info_price_spna'>IN STOCK</span>
            </div>
            <p className='ProductPage_top_info_desc'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias iure debitis voluptates? Velit, rerum similique. Voluptatem quidem esse rem illum? Praesentium doloremque fugiat tenetur, earum incidunt obcaecati! Unde, sapiente quibusdam.</p>
            ...
            <div className='ProductPage_top_info_Category'> <span>CATEGORY:</span>  <span>HEADPHONES</span>  <span>ACCESSORIES</span></div>
